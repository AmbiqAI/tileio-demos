...
extern uint16_t ecgDenMask[ECG_DEN_WINDOW_LEN];
...
extern rb_config_t rbEcgRawMet;
extern rb_config_t rbEcgNosMet;
extern rb_config_t rbEcgDenMet;
extern rb_config_t rbEcgMaskMet;

extern float32_t ecgRawMetData[ECG_MET_WINDOW_LEN];
extern float32_t ecgNosMetData[ECG_MET_WINDOW_LEN];
extern float32_t ecgDenMetData[ECG_MET_WINDOW_LEN];
extern uint16_t ecgMaskMetData[ECG_MET_WINDOW_LEN];

extern ecg_peak_f32_t ecgFindPeakCtx;
